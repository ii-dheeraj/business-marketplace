/*
  ...
  - Added the required column `businessPincode` to the `Seller` table without a default value. This is not possible if the table is not empty.
  - Added the required column `businessState` to the `Seller` table without a default value. This is not possible if the table is not empty.
